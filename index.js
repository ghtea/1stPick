...
function changeMessage() {
  ...
  let messages = ['updated: 2020. 3. 18. (UTC +9)', 'Do you have <a href="https://forms.gle/iw1yCZ2RAv2Htys36"> any opinions </a> on this website?', 'please use <a href="https://api.heroesprofile.com/upload"> Heroes Profile Uploader </a>', "'Add to Home Screen' on your iPhone Safari"]
...
function changeDataInfo() {
  ...
  let dataInfos = ["main data<br>v2.49.4.78679~ (heroes x maps)<br> v2.49~ (heroes x heroes)<br> source: <a href='https://api.heroesprofile.com'>Heroes Profile API</a>", "hero difficulty data<br>by Lucifer474 (<a href='https://1drv.ms/x/s!Ar0HIinrMYwPhJNzYBCXCPwRtxibQA?e=IZnVHV'> his work </a>)"];
